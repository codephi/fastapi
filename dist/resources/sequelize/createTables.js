...
function createTables(config, closeConnection) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 5, , 7]);
                    return [4 /*yield*/, sequelize.sync(config)];
                case 2:
                    _a.sent();
                    log_1.default.info('All tables created.');
                    if (!closeConnection) return [3 /*break*/, 4];
                ...
                case 5:
                    error_1 = _a.sent();
                    log_1.default.error('Error creating tables:', error_1);
                    return [4 /*yield*/, sequelize.close()];
                case 6:
                    _a.sent();
                    return [3 /*break*/, 7];
