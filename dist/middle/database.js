...
var Global = /** @class */ (function () {
    ...
    Global.prototype.getSequelize = function () {
        if (!this.sequelize)
...
function testDatabaseConnection() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!exports.global.sequelize) return [3 /*break*/, 2];
                    return [4 /*yield*/, exports.global.sequelize.authenticate()];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2: throw new Error('Database connection not established');
...
function databaseConnect(_a) {
    var database = _a.database, username = _a.username, password = _a.password, options = _a.options;
